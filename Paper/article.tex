...
\author{Jaime Pizarroso\\Institute for Research\\in
Technology (IIT)
   \And Jos\'e Portela\\Institute for Research\\in
Technology (IIT) 
   \And Antonio Mu\~noz\\Institute for Research\\in
Technology (IIT)}
\Plainauthor{Jaime Pizarroso, Jos\'e Portela, Antonio Mu\~noz}

%% - \title{} in title case
%% - \Plaintitle{} without LaTeX markup (if any)
%% - \Shorttitle{} with LaTeX markup (if any), used as running title
\title{NeuralSens: Analysis of the output sensitivity with respect to the inputs in neural networks}
\Plaintitle{NeuralSens: Analysis of the output sensitivity with respect to the inputs in neural networks}
\Shorttitle{NeuralSens: Neural networks sensitivity analysis}
...
\Keywords{neural networks, sensitivity, analysis, variable importance, \proglang{R}}
\Plainkeywords{neural networks, sensitivity, analysis, variable importance, R}
...
\Address{
  ...
  28015 Madrid, Spain\\
  E-mail: \email{jpizarroso@alu.comillas.edu}
}
